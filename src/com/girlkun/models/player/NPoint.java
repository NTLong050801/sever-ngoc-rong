...
public class NPoint {
    ...
    public long power;
    public long tiemNang,tiemNangGoc;

    public long hp, hpMax, hpg,hpChuan;
    public long mp, mpMax, mpg,mpChuan;
    public long dame, dameg, dameChuan;
    public int def, defg;
    ...
    private void setHpHoi() {
        this.hpHoi = Util.LeHaiGH(this.hpMax / 100);
    ...
    private void setMpHoi() {
        this.mpHoi = Util.LeHaiGH(this.mpMax / 100);
    ...
    private void setHpMax() {
        ...
        this.hpChuan = this.hpg + this.hpAdd;
        // SKH Jr
        if (this.player.setClothes.setJr >= 3 && player.nPoint.isAccJr()) {
            this.hpChuan += 1300000;
            this.hpMax += 1300000;
        }
        //đồ
        ...
        if (this.player.setClothes.sieuvip == 5) {
            this.hpMax += ((long) this.hpMax * 140 / 100);
        }
        if (this.player.setClothes.setJr >= 5 && player.nPoint.isAccJr()) {
            this.hpMax += ((long) this.hpMax * 120 / 100);
        }
        //ngọc rồng đen 1 sao
        ...
        if (player.lastTimeTitle3 > 0) {
            this.hpMax += ((long) this.hpChuan * 10 / 100);
        }
        if (player.lastTimeTitle5 > 0) {
            this.hpMax += ((long) this.hpChuan * 10 / 100);
        }
        if (player.lastTimeTitle9 > 0) {
            this.hpMax += ((long) this.hpChuan * 10 / 100);
        }
        if (player.lastTimeTitle6 > 0) {
            this.hpMax += ((long) this.hpChuan * 10 / 100);
        }
        if (player.lastTimeTitle12 > 0 && player.nhanqua == 1) {
                 this.hpMax += ((long) this.hpChuan * 5 / 100);
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 2) {
                 this.hpMax += ((long) this.hpChuan * 10 / 100);
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 3) {
                 this.hpMax += ((long) this.hpChuan * 15 / 100);
            }
        //khỉ
    ...
    private void setMpMax() {
        ...
        this.mpChuan = this.mpg + this.mpAdd;
        if (this.player.setClothes.setJr >= 3 && player.nPoint.isAccJr()) {
            this.mpChuan += 1300000;
            this.mpMax += 1300000;
        }
        //đồ
        ...
        if (player.lastTimeTitle4 > 0) {
            this.mpMax += ((long) this.mpChuan * 10 / 100);
        }
        if (player.lastTimeTitle9 > 0) {
            this.mpMax += ((long) this.mpChuan * 10 / 100);
        }
        ...
        if (player.lastTimeTitle12 > 0 && player.nhanqua == 1) {
                 this.mpMax += ((long) this.mpChuan * 5 / 100);
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 2) {
                 this.mpMax += ((long) this.mpChuan * 10 / 100);
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 3) {
                 this.mpMax += ((long) this.mpChuan * 15 / 100);
            }
        //pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
                && ((Pet) this.player).master.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA) {
    ...
    private void setDame() {
        ...
        this.dameChuan = this.dameg + this.dameAdd;
        if (this.player.setClothes.setJr >= 3 && player.nPoint.isAccJr()) {
            this.dameChuan += 80000;
            this.dame += 80000;
        }
        //đồ
        ...
        if (this.player.isPet){
            for (Integer tl : ((Pet) this.player).master.nPoint.tlDameDT) {
          this.dame += ((long) dameChuan*tl/100);
    }
        if (((Pet) this.player).master.setClothes.setJr == 6 && ((Pet) player).master.nPoint.isAccJr()) {
             this.dame += dameChuan*50/100;
        } 
        }
        if (this.player.setClothes.sucdanh == 5) {
        ...
        if (player.lastTimeTitle1 > 0) {
            this.dame += ((long) this.dameChuan * 10 / 100);
        }
        if (player.lastTimeTitle16 > 0) {
            this.dame += ((long) this.dameChuan * 15 / 100);
        }
        if (player.lastTimeTitle7 > 0) {
            this.dame += ((long) this.dameChuan * 10 / 100);
        }
        if (player.lastTimeTitle8 > 0) {
            this.dame += ((long) this.dameChuan * 10 / 100);
        }
        if (player.lastTimeTitle5 > 0) {
            this.dame += ((long) this.dameChuan * 10 / 100);
        ...
        if (player.lastTimeTitle2 > 0) {
            this.dame += ((long) this.dameChuan * 5 / 100);
        }
        if (player.lastTimeTitle12 > 0 && player.nhanqua == 1) {
                this.dame += ((long) this.dameChuan * 5 / 100);
            }
        ...
        if (this.player.id == 2103) {
            this.dame/= 10;
        }
        if (this.player.id == 717) {
            this.dame*= 5;
        }
        if (this.player.id == 51) {
            this.dame*= 5;
        }
    ...
    public float getDameAttack(boolean isAttackMob) {
        ...
        switch (skillSelect.template.id) {
            case Skill.DRAGON:
                ...
                if (this.player.setClothes.setJr >= 2 && player.nPoint.isAccJr()) {
            ...
            case Skill.GALICK:
                ...
                if (this.player.setClothes.radic == 5) {
                    dameAttack += dameAttack * 50 / 100;
                }
                if (this.player.setClothes.setJr >= 2 && player.nPoint.isAccJr()) {
                    dameAttack += dameAttack * 100 / 100;
            ...
            case Skill.KAIOKEN:
                ...
                if (this.player.setClothes.santa == 5) {
                    dameAttack += dameAttack * 50 / 100;
                }
                if (this.player.setClothes.setJr >= 2 && player.nPoint.isAccJr()) {
                    dameAttack += dameAttack * 100 / 100;
            ...
            case Skill.DICH_CHUYEN_TUC_THOI:
                dameAttack *= 2;
                dameAttack = Util.LeHainext(dameAttack - (dameAttack * 5 / 100),
        ...
        if (isCrit) {
            long dameCrit = dameAttack ;
            dameAttack *= 2;
            for (Integer tl : this.tlDameCrit) {
                dameAttack += (dameCrit * tl / 100);
            }
              if (this.player.setClothes.setJr >= 4 && player.nPoint.isAccJr()) {
                    dameAttack += dameCrit * 40 / 100;
                }
        }
  ...
  //      if (player.isPl() && dameAttack >= 200000000) {
   ...
   //     }
    ...
    public long calSucManhTiemNang(long tiemNang) {
        if (power < getPowerLimit()) {
         tiemNangGoc = tiemNang ;
            for (Integer tl : this.tlTNSM) {
                tiemNang += ((long) tiemNangGoc * tl / 100);
            }
            if (this.player.isPet){
            for (Integer tl : ((Pet) player).master.nPoint.tlTNSMDT) {
            tiemNang += ((long) tiemNangGoc*tl/100);
    }}
            if (player.CapCS > 0) {
                tiemNang += ((long) tiemNangGoc * 25 / 100);
            }
            if (player.lastTimeTitle5 > 0) {
                tiemNang += ((long) tiemNangGoc * 5 / 100);
            }
            if (player.lastTimeTitle17 > 0) {
                tiemNang += ((long) tiemNangGoc * 10 / 100);
            }
            if (player.lastTimeTitle15 > 0) {
                tiemNang += ((long) tiemNangGoc * 10 / 100);
            }
            if (player.lastTimeTitle10 > 0) {
                tiemNang += ((long) tiemNangGoc * 10 / 100);
            }
            if (player.lastTimeTitle14 > 0) {
                tiemNang += ((long) tiemNangGoc * 20 / 100);
            }
            if (player.lastTimeTitle13 > 0) {
                tiemNang += ((long) tiemNangGoc * 30 / 100);
            }
            if (player.lastTimeTitle16 > 0) {
                tiemNang += ((long) tiemNangGoc * 15 / 100);
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 1) {
                tiemNang += ((long) tiemNangGoc * 5 / 100);
            }
            ...
            if (player.CapCS > 0) {
                tiemNang += tiemNangGoc * 25 / 100;
            }
            if (player.lastTimeTitle5 > 0) {
                tiemNang += tiemNangGoc * 5 / 100;
            }
            if (player.lastTimeTitle17 > 0) {
                tiemNang += tiemNangGoc * 10 / 100;
            }
            if (player.lastTimeTitle10 > 0) {
                tiemNang += tiemNangGoc * 10 / 100;
            }
            if (player.lastTimeTitle14 > 0) {
                tiemNang += tiemNangGoc * 20 / 100;
            }
            if (player.lastTimeTitle13 > 0) {
                tiemNang += tiemNangGoc * 30 / 100;
            }
            if (player.lastTimeTitle16 > 0) {
                tiemNang += tiemNangGoc * 15 / 100;
            }
            if (player.lastTimeTitle12 > 0 && player.nhanqua == 1) {
                tiemNang += tiemNangGoc * 5 / 100;
            }
            ...
            if (this.player.charms.tdTriTue > System.currentTimeMillis()) {
                tiemNang += tiemNangGoc;
            }
            if (this.player.charms.tdTriTue3 > System.currentTimeMillis()) {
                tiemNang += tiemNangGoc * 2;
            }
            if (this.player.charms.tdTriTue4 > System.currentTimeMillis()) {
                tiemNang += tiemNangGoc * 3;
            }
            if (this.player.itemTime != null && this.player.itemTime.isUsex2) {
            tiemNang += tiemNangGoc* 2;
        }
            if (this.player.itemTime != null && this.player.itemTime.isUsex5) {
            tiemNang += tiemNangGoc* 5;
        }
            if (this.player.itemTime != null && this.player.itemTime.isUsex7) {
            tiemNang += tiemNangGoc * 7;
        }
            if (this.player.itemTime != null && this.player.itemTime.isUsex10) {
            tiemNang += tiemNangGoc * 10;
        }
            if (this.player.isPet) {
                if (((Pet) this.player).master.charms.tdDeTu > System.currentTimeMillis()) {
                    tiemNang += tiemNangGoc * 2;
                }
                if (((Pet) this.player).master.itemTime != null && ((Pet) this.player).master.itemTime.isUsex2)
                {tiemNang += tiemNangGoc * 2;
                }
                if (((Pet) this.player).master.itemTime != null && ((Pet) this.player).master.itemTime.isUsex5)
                {tiemNang += tiemNangGoc * 5;
                }
                if (((Pet) this.player).master.itemTime != null && ((Pet) this.player).master.itemTime.isUsex7)
                {tiemNang += tiemNangGoc * 7;
                }
                if (((Pet) this.player).master.itemTime != null && ((Pet) this.player).master.itemTime.isUsex10)
                {tiemNang += tiemNangGoc * 10;
                }
            }
    ...
    public long calSubTNSM(long tiemNang) {
        ...
        if (power >= 590000000000L) {
            tiemNang -= ((long) tiemNang * 99.99 / 100);
        }
        if (power >= 580000000000L) {
            tiemNang -= ((long) tiemNang * 99 / 100);
        }
        if (power >= 550000000000L) {
            tiemNang -= ((long) tiemNang * 90 / 100);
        }
        if (power >= 500000000000L) {
            tiemNang -= ((long) tiemNang * 70 / 100);
        }
        if (power >= 400000000000L) {
            tiemNang -= ((long) tiemNang * 60 / 100);
        }
    ...
    public float subDameInjureWithDeff(float dame) {
     ...
     public boolean isAccJr() {
    return this.hpg == 20 && this.mpg == 20 && this.dameg == 1;
}
    /*------------------------------------------------------------------------*/
    ...
    public long getPowerLimit() {
        switch (limitPower) {
            ...
            case 2:
                return 180000000000L;
            case 3:
                return 240000000000L;
            case 4:
                return 300000000000L;
            case 5:
                return 360000000000L;
            case 6:
                return 420000000000L;
            case 7:
                return 480000000000L;
            case 8:
                return 540000000000L;
            case 9:
