...
public boolean isDHK() {
        if (this.template.id >= 2069 && this.template.id <= 2083) {
            return true;
        }
        return false;
    }

public boolean isDHKVIP() {
        if (this.template.id >= 2069 && this.template.id <= 2083) {
            return true;
        }
        return false;
...
public boolean isManhTS() {
    ...
    public boolean isManhTS1() {
        if (this.template.id >= 1181 && this.template.id <= 1185) {
            return true;
        }
        return false;
    }

    public boolean isCongThucVip1() {
         if (this.template.id >= 1206 && this.template.id <= 1208) {
            return true;
        }
        return false;
    }
    ...
    public boolean isDaNangCap1() {
        if (this.template.id >= 1187 && this.template.id <= 1191) {
            return true;
        } else if (this.template.id == -1) {
        }
        return false;
    ...
    public boolean isDaMayMan1() {
        if (this.template.id >= 1192 && this.template.id <= 1196) {
            return true;
        }
        return false;
    }
