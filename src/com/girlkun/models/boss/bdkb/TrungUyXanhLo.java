...
public class TrungUyXanhLo extends Boss {
    ...
    public TrungUyXanhLo(Zone zone , int level, int dame, long hp) throws Exception {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap it = new ItemMap(this.zone, 1375, 3, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
