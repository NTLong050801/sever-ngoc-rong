...
public class nguyet extends Boss {
    private long lastTimeHapThu;
    private int timeHapThu;
    public nguyet() throws Exception {
        super(BossID.nguyet, BossesData.nguyet);
    }

    @Override
    public void reward(Player plKill) {
        int[] itemDos = new int[]{1191,1196};
        int[] itemDo = new int[]{1191,1196};
        ...
        if (Util.isTrue(BossManager.ratioReward, 100)) {
            if (Util.isTrue(10, 100)) {
              Service.gI().dropItemMap(this.zone, Util.useItem2(zone, itemDos[randomDo], 1, this.location.x, this.location.y, plKill.id));
                 ...
                 Service.gI().dropItemMap(this.zone, Util.useItem2(zone, itemDo[randomDo], 1, this.location.x, this.location.y, plKill.id));
            }
        } 
    }
    @Override
