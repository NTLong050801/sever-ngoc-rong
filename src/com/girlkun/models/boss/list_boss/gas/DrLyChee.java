...
public class DrLyChee extends Boss {
    ...
    public DrLyChee(Zone zone, int level, int dame, long hp) throws Exception {
    ...
    public void reward(Player plKill) {
        ...
        if (level < 20) {
            ...
            itemMap.options.add(new Item.ItemOption(14,(int) level / 10));
            itemMap.options.add(new Item.ItemOption(30, 0));
            Service.getInstance().dropItemMap(this.zone, itemMap);
        } else if (level <= 50 && levell >= 20) {
            ItemMap itemMap;
            itemMap = Util.ratiItem(zone, 2016, 1, this.location.x, this.location.y, plKill.id);
