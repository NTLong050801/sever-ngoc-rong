 ...
 *@Stole By Arriety
 */
public class TienLong3 extends Boss {

    public TienLong3() throws Exception {
        super(BossID.ThienLong3, BossesData.ThienLong3);
    }

    @Override
    public void reward(Player plKill) {
        ItemMap itemMap;
        itemMap = Util.ratiItem(zone,1705, 1, this.location.x, this.location.y, plKill.id);
        ...
        itemMap.options.add(new Item.ItemOption(81,Util.nextInt(10,30)));
        itemMap.options.add(new Item.ItemOption(108,Util.nextInt(40,70)));
        itemMap.options.add(new Item.ItemOption(93,Util.nextInt(1,3)));
        itemMap.options.add(new Item.ItemOption(30,0));
                                }    
        plKill.LeHoi += 5;
