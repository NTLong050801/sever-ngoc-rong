 ...
 *@Stole By Arriety
 */
public class TienLong1 extends Boss {

    public TienLong1() throws Exception {
        super(BossID.ThienLong1, BossesData.ThienLong1);
    }

    @Override
    public void reward(Player plKill) {
        ItemMap itemMap;
        itemMap = Util.ratiItem(zone,1703, 1, this.location.x, this.location.y, plKill.id);
        ...
        itemMap.options.add(new Item.ItemOption(80,Util.nextInt(10,30)));
        ...
        itemMap.options.add(new Item.ItemOption(81,Util.nextInt(10,30)));
        itemMap.options.add(new Item.ItemOption(80,Util.nextInt(10,30)));
        itemMap.options.add(new Item.ItemOption(181,Util.nextInt(30,60)));
