...
public class ItemTimeService {
    ...
    public void sendAllItemTime(Player player) {
        ...
        if (player.itemTime.isUsex2) {
            sendItemTime(player, 21881, (int) ((TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimex2)) / 1000));
        }
        if (player.itemTime.isUsex5) {
            sendItemTime(player, 21878, (int) ((TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex5)) / 1000));
        }
        if (player.itemTime.isUsex7) {
            sendItemTime(player, 21879, (int) ((TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex7)) / 1000));
        }
        if (player.itemTime.isUsex10) {
            sendItemTime(player, 21880, (int) ((TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex10)) / 1000));
        }
