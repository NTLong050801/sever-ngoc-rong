...
public class PlayerService {
    ...
    public void sendInfoHp(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.LeHaiGH(player.nPoint.hp));
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
    ...
    public void sendInfoMp(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.LeHaiGH(player.nPoint.mp));
            player.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Logger.logException(PlayerService.class, e);
    ...
    public void hoiPhuc(Player player, float hp, float mp) {
        if (!player.isDie()) {
    ...
    public void sendInfoHpMpMoney(Player player) {
        ...
        try {
            ...
            msg.writer().writeInt(Util.LeHaiGH(player.nPoint.hp));//chp
            msg.writer().writeInt(Util.LeHaiGH(player.nPoint.mp));//cmp
