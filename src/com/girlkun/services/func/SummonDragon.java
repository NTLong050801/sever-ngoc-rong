...
public class SummonDragon {
   ...
   public static final byte WISHED = 0;
    ...
    private final int timeResummontrb = 100000;
                ...
                switch (this.select) {
                    case 0: //đẹp trai nhất vũ trụ
                        if (InventoryServiceNew.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            avtVip.itemOptions.add(new ItemOption(97, Util.nextInt(40, 60)));
                            avtVip.itemOptions.add(new ItemOption(77, Util.nextInt(10, 20)));
                            avtVip.itemOptions.add(new ItemOption(117, Util.nextInt(20, 40)));
                    ...
                    case 3: //+150 ngọc
                     ...
                     case 4: 
                        if (InventoryServiceNew.gI().getCountEmptyBag(playerSummonShenron) > 0) {
                            ...
                            avtVip.itemOptions.add(new ItemOption(50, Util.nextInt(20, 43)));
                            avtVip.itemOptions.add(new ItemOption(77, Util.nextInt(20, 43)));
                            avtVip.itemOptions.add(new ItemOption(103, Util.nextInt(20, 43)));
                            avtVip.itemOptions.add(new ItemOption(5, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(14, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(95, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(96, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(93, Util.nextInt(1, 365)));
                            avtVip.itemOptions.add(new ItemOption(30, 0));
                            } else {
                            avtVip.itemOptions.add(new ItemOption(50, Util.nextInt(20, 42)));
                            avtVip.itemOptions.add(new ItemOption(77, Util.nextInt(20, 42)));
                            avtVip.itemOptions.add(new ItemOption(103, Util.nextInt(20, 42)));
                            avtVip.itemOptions.add(new ItemOption(5, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(14, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(95, Util.nextInt(5, 10)));
                            avtVip.itemOptions.add(new ItemOption(96, Util.nextInt(5, 10)));
