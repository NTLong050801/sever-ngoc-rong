        ...
        switch (npc.tempId) {
            ...
            case ConstNpc.MAI:
                return (doneTask(player, ConstTask.TASK_22_0)
                 ...
                 case ConstNpc.FA:
                return (doneTask(player, ConstTask.TASK_29_7)
                 ...
                 case BossType.COOLER:
                     switch (boss.currentLevel) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            doneTask(player, ConstTask.TASK_29_6);
                            break;
                    }
                    break;   
...
//        }
    ...
    public void checkDoneSideTaskKillMob(Player player, Mob mob) {
        if (player.playerTask.sideTask.template != null && !player.isPet) {
