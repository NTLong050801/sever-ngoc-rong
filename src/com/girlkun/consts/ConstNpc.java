...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại chiến\n"
            ...
            + "Lưu ý mỗi bang có thể chiếm hữu nhiều viên khác nhau nhưng nếu cùng loại cũng chỉ nhận được 1 lần phần thưởng đó. Cách để thắng:\n"
            + " Giữ ngọc sao đen trên người hơn 5 phút liên tục\n"
            + " 1s tăng sức đánh \n 2s tăng hp và giáp \n 3s tăng ki và chí mạng \n 4s tăng dame lên quái \n 5s tăng pst \n 6s tăng né \n 7s tăng hồi hp và hút hp";
    ...
    public static final String SU_KIEN_HE = "Trong thời gian diễn ra sự kiện:\n"
            + "Farm quái các map tương lai sẽ rơi vật phẩm sự kiện.\n"
            + "Cần x33 vật phẩm giấy, vải, tre, dây và 10 thỏi vàng để đổi vật phẩm diều giấy\n"
            + "Cần x101 vật phẩm giấy, vải, tre, dây và 4 tờ 10k vnd để đổi vật phẩm diều vải.\n"
            + "Diều cũng có thể kiếm tại các boss sự kiện\n"
            + "Sử dụng diều được các vật phẩm giá trị.";
    ...
    public static final byte LeHoi = 37;
    ...
    public static final byte TK = 70;
    public static final byte HK = 97;
    public static final byte TD = 87;
    public static final byte HD = 88;
    ...
    public static final byte CHAN_MENH = 103;
     public static final byte naruto = 108;
    ...
    public static final byte MEO_THAN_TAI1 = 99;
     public static final byte NGHE_NGHIEP = 78;
     public static final byte EVENT = 60;
    //----------------------index menu------------------------------------------
...
public static final int BASE_MENU1 = 7520022;
    //index quy lão kamê
    public static final int MENU_OPEN_DBKB = 550;
    public static final int MENU_OPENED_DBKB = 186;
    public static final int MENU_ACCEPT_GO_TO_BDKB = 502;
    public static final int MENU_BDKB = 186;
 public static final int MENU_ABV = 200;
    //index than vu tru
    ...
    public static final int MENU_CS = 509;
...
public static final int TTMEM = 518;
    ...
    public static final int MENU_OPTION_USE_ITEM2033 = 2033;
    public static final int MENU_OPTION_USE_ITEM2034 = 2034;
    public static final int MENU_OPTION_USE_ITEM2035 = 2035;
    public static final int MENU_OPTION_USE_ITEM2036 = 2036;
    public static final int MENU_OPTION_USE_ITEM2037 = 2037;
    public static final int MENU_OPTION_USE_ITEM2038 = 2038;
