    ...
    public void run() {
        while (!Maintenance.isRuning) {
            try {
                ...
                if (Util.canDoWithTime(this.lastTimeGK, 320000)) {
                    sendThongBaoBenDuoi("Chào mừng bạn đã đến server NGỌC RỒNG MP CHÚC CÁC BẠN CHƠI GAME VUI VẺ");
                    sendThongBaoBenDuoi("Có tổng cộng 17 SKH, trong đó có 7 loại SKH có thể up tại 3 map đầu làng.");
                    sendThongBaoBenDuoi("Thỏi vàng up quái tại tất cả các map (không tự động hút vào người)");
                    sendThongBaoBenDuoi("Quái all map có tỉ lệ rơi VND , hồng ngọc săn boss hải tặc.");
                    sendThongBaoBenDuoi("Boss 12h, boss map Cereal, quái BDKB lv 110, quái khí GAS 110 có tỉ lệ rơi đồ TL và đồ TS vip.");
