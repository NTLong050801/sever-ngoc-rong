...
//                                Service.gI().sendThongBao(player, "Đang bảo trì...");
    ...
    public void login2(MySession session, Message msg) {
        ...
        Service.gI().sendThongBaoOK(session, "Vui lòng đăng ký tài khoản tại nrvinhquang.io.vn!");
    }
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với KABUTO\n"
        ...
        if (player.lastTimeTitle1 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 300);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle2 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 301);
                } catch (Exception e) {
                }
            }).start();
        }
        ...
        if (player.lastTimeTitle4 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 893);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle5 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) player.gender + 100);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle6 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 109);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle7 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 111);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle13 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 131);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle14 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 132);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle15 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 133);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle16 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 134);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle17 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 135);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle8 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 108);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle9 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 114);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle10 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 115);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle11 > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) player.pointTop + 122);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle12 > 0 && player.getSession().tongnap >= 0 && player.getSession().tongnap < 50000) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 117);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle12 > 0 && player.getSession().tongnap >= 50000 && player.getSession().tongnap <= 150000) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 121);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.CapCS > 0) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 112);
                } catch (Exception e) {
                }
            }).start();
        }
        if (player.lastTimeTitle12 > 0 && player.tongnap > 150000) {
            new Thread(() -> {
                try {
                    Thread.sleep(1000);
                    Service.getInstance().sendTitle(player, (short) 122);
                } catch (Exception e) {
                }
            }).start();
        }
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "NR KABUTO\nCHÚC CÁC BẠN CHƠI GAME VUI VẺ !!");
    }
