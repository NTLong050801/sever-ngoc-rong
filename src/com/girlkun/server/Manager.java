...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final List<Item> RUBY_REWARDS = new ArrayList<>();
                                                                 //          áo       quần      găng       giày     áo       quần      găng       giày       áo       quần      găng       giày    9    10   11   12
    ...
    public static final short[] itemThu = {1406, 1407, 1408, 1409};

    
    public static final short[] dobosstl = {1181,1182,1183,1184,1185,16,457};
    ...
    public static final short[] radaSKHVip1 = {2073, 2078, 2083};
    public static final short[] ao0 = {1048,555,2069};
    public static final short[] quan0 = {1051,556,2070};
    public static final short[] gang0 = {1054,562,2071};
    public static final short[] giay0 = {1057,563,2072};
    public static final short[] ao1 = {1049,557,2074};
    public static final short[] quan1 = {1052,558};
    public static final short[] gang1 = {1055,564};
    public static final short[] giay1 = {1058,565};
    public static final short[] ao2 = {1050,559};
    public static final short[] quan2 = {1053,560};
    public static final short[] gang2 = {1056,566};
    public static final short[] giay2 = {1059,567};
    //ist mts
    public static final short[] manhts = {1067, 1068, 1069, 1070, 1066};
    public static final short[] manhts1 = {1181, 1182, 1183, 1184, 1185};
    public static final short[] manhts2 = {1187, 1188, 1189, 1190, 1191,1192,1193,1194,1195,1196,1206,1207,1208};
    public static final short[] manhts3 = {1197, 1198,1199};
    //isst t.a
    ...
    public static final short[][][] doSKHVip1 = {{ao0, quan0, gang0, giay0}, {ao1, quan1, gang1, giay1}, {ao2, quan2, gang2, giay2}};
...
//                    dataArray.clear();
            ...
            Logger.success( "Load item ký gửi thành công (" + ShopKyGuiManager.gI().listItem.size() + ")!\n");
            try {
                if (rs != null) {
                    rs.close();
                }
