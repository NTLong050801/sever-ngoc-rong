...
public class PlayerDAO {
    ...
    public static boolean createNewPlayer(int userId, String name, byte gender, int hair) {
        try {
            ...
            dataArray.add(1000000); //vàng
            dataArray.add(1000000); //ngọc xanh
            dataArray.add(5000000); //hồng ngọc
            dataArray.add(100); //point
            ...
            dataArray.add(2000); //thể lực
            dataArray.add(2000); //thể lực đầy
            ...
            dataArray.add(0); //thức ăn cold
            dataArray.add(0); //icon thức ăn cold
            String itemexp = dataArray.toJSONString();
            dataArray.clear();
            dataArray.add(0); //máy dò
            dataArray.add(0); //máy dò2
            dataArray.add(0); //thức ăn cold
            ...
            dataArray.add(0); //máy dò2
            dataArray.add(0); //thức ăn cold
            String data_item_time_ngoc_rong = dataArray.toJSONString();
            dataArray.clear();
            ...
            GirlkunDB.executeUpdate("insert into player"
                    ...
                    + "items_bag, items_box, items_box_lucky_round, friends, enemies, data_intrinsic, data_item_time, data_item_exp,"
                    + "data_task,  data_charm, skills, skills_shortcut, pet,"
                    + "data_black_ball, data_side_task, violate,  data_item_time_sieu_cap,  data_item_time_ngoc_rong, info_achievement) "
                    ...
                    itemTime, itemexp, task, charms, skills, skillsShortcut, petData, dataBlackBall, dataSideTask, 0, data_item_time_sieu_cap, data_item_time_ngoc_rong, info_achive);
    ...
    public static void updatePlayer(Player player) {
        ...
        if (player.iDMark.isLoadedAllDataPlayer()) {
            ...
            try {
                ...
                int hp = Util.LeHaiGH(player.nPoint.hp);
                int mp = Util.LeHaiGH(player.nPoint.mp);
                if (player.isDie()) {
                ...
                dataArray.add(player.nPoint.nghenghiep);
                dataArray.add(hp);
                dataArray.add(mp);
                String point = dataArray.toJSONString();
                dataArray.clear();
                ...
                String itemTime = dataArray.toJSONString();
                dataArray.clear();
                dataArray.add((player.itemTime.isUsex2 ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimex2)) : 0));
                dataArray.add((player.itemTime.isUsex5 ? (ItemTime.TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex5)) : 0));
                dataArray.add((player.itemTime.isUsex7 ? (ItemTime.TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex7)) : 0));
                dataArray.add((player.itemTime.isUsex10 ? (ItemTime.TIME_EXP - (System.currentTimeMillis() - player.itemTime.lastTimex10)) : 0));
                String itemexp = dataArray.toJSONString();
                dataArray.clear();
                //data nhiệm vụ
                ...
                String dhtime6 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse8 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle8);
                String dhtime8 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse9 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle9);
                String dhtime9 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse10 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle10);
                String dhtime10 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse11 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle11);
                String dhtime11 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse12 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle12);
                String dhtime12 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse13 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle13);
                String dhtime13 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse14 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle14);
                String dhtime14 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse15 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle15);
                String dhtime15 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse16 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle16);
                String dhtime16 = dataArray.toJSONString();
                dataArray.clear();

                dataArray.add(player.isTitleUse17 == true ? 1 : 0);
                dataArray.add(player.lastTimeTitle17);
                String dhtime17 = dataArray.toJSONString();
                dataArray.clear();
                ...
                dataArray.clear();
                dataArray.add((player.itemTime.istrbsd ? (ItemTime.TIME_TRB - (System.currentTimeMillis() - player.itemTime.lastTimetrbsd)) : 0));
                dataArray.add((player.itemTime.istrbhp ? (ItemTime.TIME_TRB - (System.currentTimeMillis() - player.itemTime.lastTimetrbhp)) : 0));
                dataArray.add((player.itemTime.istrbki ? (ItemTime.TIME_TRB - (System.currentTimeMillis() - player.itemTime.lastTimetrbki)) : 0));

                String itemTimeNR = dataArray.toJSONString();
                dataArray.clear();
                //data item time sc
                JSONObject achievementObject = new JSONObject();
                ...
                String query = " update player set info_achievement =?,data_item_time_sieu_cap = ?,  data_item_time_ngoc_rong = ?, head = ?, have_tennis_space_ship = ?,"
                        ...
                        + "enemies = ?, data_intrinsic = ?, data_item_time = ?, data_item_exp = ?, data_task = ?,  pet = ?,"
                        + "data_black_ball = ?, data_side_task = ?, data_charm = ?, skills = ?,dhtime1=?,dhtime2=?,dhtime3=?,dhtime4=?,dhtime5=?,dhtime6=?,dhtime7=?,dhtime8=?,dhtime9=?,dhtime10=?,dhtime11=?,dhtime12=?,dhtime13=?,dhtime14=?,dhtime15=?,dhtime16=?,dhtime17=?,"
                        + " skills_shortcut = ?, violate=?, pointTop=? , CapCS=?, LeHoi=?, nhanqua= ? where id = ?";
    ...
    public static boolean congvnd(Player player, int num) {
