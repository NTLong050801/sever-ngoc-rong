                ...
                if (rs.getBoolean("ban")) {
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            player.pointTop = rs.getInt("pointTop");
                            player.nhanqua = rs.getInt("nhanqua");
                            player.CapCS = rs.getInt("CapCS");
                            player.LeHoi = rs.getInt("LeHoi");
                            ...
                            player.nPoint.nghenghiep = Byte.parseByte(String.valueOf(dataArray.get(10))); //** Năng động
                            ...
                            dataArray.clear();
                            dataArray = (JSONArray) jv.parse(rs.getString("data_item_exp"));
                            int timex2 = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            int timex5 = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            int timex7 = Integer.parseInt(String.valueOf(dataArray.get(2)));
                            int timex10 = Integer.parseInt(String.valueOf(dataArray.get(3)));

                            player.itemTime.lastTimex2 = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timex2);
                            player.itemTime.lastTimex5 = System.currentTimeMillis() - (ItemTime.TIME_EXP - timex5);
                            player.itemTime.lastTimex7 = System.currentTimeMillis() - (ItemTime.TIME_EXP - timex7);
                            player.itemTime.lastTimex10 = System.currentTimeMillis() - (ItemTime.TIME_EXP - timex10);

                            player.itemTime.isUsex2 = timex2 != 0;
                            player.itemTime.isUsex5 = timex5 != 0;
                            player.itemTime.isUsex7 = timex7 != 0;
                            player.itemTime.isUsex10 = timex10 != 0;
                            dataArray.clear();
                            //dataa siu cap
                            ...
                            dataArray.clear();
                            dataArray = (JSONArray) jv.parse(rs.getString("data_item_time_ngoc_rong"));
                            int nrtbrsd = Integer.parseInt(String.valueOf(dataArray.get(0)));
                            int nrtbrhp = Integer.parseInt(String.valueOf(dataArray.get(1)));
                            int nrtbrki = Integer.parseInt(String.valueOf(dataArray.get(2)));

                            player.itemTime.lastTimetrbsd = System.currentTimeMillis() - (ItemTime.TIME_TRB - nrtbrsd);
                            player.itemTime.lastTimetrbhp = System.currentTimeMillis() - (ItemTime.TIME_TRB - nrtbrhp);
                            player.itemTime.lastTimetrbki = System.currentTimeMillis() - (ItemTime.TIME_TRB - nrtbrki);

                            player.itemTime.istrbsd = nrtbrsd != 0;
                            player.itemTime.istrbhp = nrtbrhp != 0;
                            player.itemTime.istrbki = nrtbrki != 0;
                            ...
                            if (!petData.isEmpty()) {
                                ...
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime1"));
                                ...
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime6"));
                                player.isTitleUse6 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle6 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime7"));
                                player.isTitleUse7 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle7 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();

                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime8"));
                                player.isTitleUse8 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle8 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();

                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime9"));
                                player.isTitleUse9 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle9 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();

                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime10"));
                                player.isTitleUse10 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle10 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();

                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime11"));
                                player.isTitleUse11 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle11 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime12"));
                                player.isTitleUse12 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle12 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime13"));
                                player.isTitleUse13 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle13 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime14"));
                                player.isTitleUse14 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle14 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime15"));
                                player.isTitleUse15 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle15 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime16"));
                                player.isTitleUse16 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle16 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                dataArray = (JSONArray) jv.parse(rs.getString("dhtime17"));
                                player.isTitleUse17 = Integer.parseInt(String.valueOf(dataArray.get(0))) == 1 ? true : false;
                                player.lastTimeTitle17 = Long.parseLong(String.valueOf(dataArray.get(1)));
                                dataArray.clear();
                                //data skills
